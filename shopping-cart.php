...
<div class="container">
    <nav class="biolife-nav">
        <ul>
            ...
            <li class="nav-item"><span class="current-page">Votre Panier</span></li>
        </ul>
    </nav>
</div>
    ...
    <div id="main-content" class="main-content">
        <div class="container">
            ...
            <div class="shopping-cart-container">
                <div class="row">
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12" id="cart_details">
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                        <div class="shpcart-subtotal-block">
                            <div class="subtotal-line">
                                <b class="stt-name">Subtotal: <span class="sub qty"></span> <span style="font-weight: 300;">Article</span> </b>
                                <span class="stt-price sub-total"> TND
                                <?php  
                        // echo isset($_SESSION['name_p'] ) ? $_SESSION['name_p']  : 
                        // $_SESSION['name_p'] = "0"; 
                        ...
                        ?> 
                            ...
                            <div class="tax-fee">
                                ...
                                <p class="desc"> pour toute commande de 50, TND</p>
                            </div>
